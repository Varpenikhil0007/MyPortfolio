...
export const projects = [
  ...
  {
    title: "IIT-Bombay",
    description: "NPTL:- Database management System",
    link: "https://drive.google.com/file/d/1vpPtjzjqyrbJeKPxeudoll7rsLTI3_AI/view?usp=drive_link",
  },
  {
    title: "Udemy",
    description: "Css,Bootstrap,JS and PHP:- JS crash course",
  ...
  {
    title: "Linkdin",
    description: "Introduction to Generative AI and advanced features",
